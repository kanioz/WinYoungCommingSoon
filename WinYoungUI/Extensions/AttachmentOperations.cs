...
namespace WinYoungUI.Extensions
{
    ...
    {
        public static Image FromBase64(string encodedString)
        {
            var bytes = Convert.FromBase64String(encodedString.Split(',')[1]);
        ...
        private static string GetFolderName(Enums.AttachmentType imageType)
        {
            switch (imageType)
            {
                ...
                case Enums.AttachmentType.UserAvatar:
                    return "UserAvatars";
                case Enums.AttachmentType.VideoCategory:
                    return "VideoCategories";
                case Enums.AttachmentType.Video:
                    return "Videos";
                case Enums.AttachmentType.LibraryDocument:
                    return "LibraryDocuments";
                case Enums.AttachmentType.LibraryImage:
                    return "LibraryImages";
                case Enums.AttachmentType.SiteCategory:
                    return "SiteCategories";
                default:
                    throw new Exception("ImageTipi bulunamadı");
            }
        }
        public static string GetImageLocation(Microsoft.AspNetCore.Hosting.IHostingEnvironment hostingEnv, string fileName, Enums.AttachmentType imageType)
        {
            var noimage = Store.NoImagePath;
